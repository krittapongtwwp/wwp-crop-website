  ...
  if (isEditing) {
    return (
      <div className="space-y-6">
        ...
        <form
          onSubmit={handleSave}
          className="bg-white dark:bg-[#050A15] shadow-sm rounded-xl border border-gray-200 dark:border-white/10 p-6 space-y-6">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4 max-h-96 overflow-y-auto p-2">
                  {imageHistory.map((img) => (
                    <div
                      ...
                      onClick={() => setCurrentItem({ ...currentItem, cover_image: img.image_url })}>
                      <img
                        src={img.image_url}
                        alt={img.prompt}
              ...
              <div className="flex items-center space-x-4">
                ...
                <div className="flex-1">
                  ...
                  <div className="flex items-center space-x-2">
                    <label
                      className={`cursor-pointer inline-flex items-center px-3 py-1.5 bg-white dark:bg-white/5 border border-gray-200 dark:border-white/10 rounded-lg text-xs font-medium text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-white/10 transition-colors ${uploading ? 'opacity-50 cursor-not-allowed' : ''}`}>
