      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">
            Manage modular sections and content for the main landing page.
          </p>
        </div>
              ...
              <div className="px-6 py-4 border-b border-gray-200 dark:border-white/10 flex justify-between items-center">
                <div className="flex items-center space-x-4">
                  <h3 className="text-lg font-medium text-gray-900 dark:text-white">
                    Edit: {activeSection.section_key === 'hero' ? 'Hero Banners' : activeSection.section_key}
                  </h3>
                </div>
                          ...
                          <div className="flex items-start">
                            ...
                            <div>
                              ...
                              <p className="text-xs text-blue-800 dark:text-blue-400 mt-1 leading-relaxed">
                                Manage multiple banners for the homepage hero carousel. Each banner can have its own
                                title, description, and media (image or video).
                              </p>
                            ...
                            <div className="flex items-center space-x-4">
                              <div className="flex items-center">
                                ...
                                <input
                                  ...
                                  onChange={(e) =>
                                    setCurrentBanner({ ...currentBanner, sort_order: parseInt(e.target.value) || 0 })
                                  }
                              ...
                              <label className="flex items-center space-x-2 cursor-pointer">
                                <input
                                  ...
                                  onChange={(e) =>
                                    setCurrentBanner({ ...currentBanner, is_active: e.target.checked ? 1 : 0 })
                                  }
                    ...
                    <div className="space-y-6">
                      ...
                      <div>
                        ...
                        <input
                          ...
                          onChange={(e) =>
                            handleChange(activeTab === 'en' ? 'subtitle_en' : 'subtitle_th', e.target.value)
                          }
                      ...
                      <div>
                        ...
                        <textarea
                          rows={3}
                          value={
                            activeTab === 'en' ? activeSection.description_en || '' : activeSection.description_th || ''
                          }
                          onChange={(e) =>
                            handleChange(activeTab === 'en' ? 'description_en' : 'description_th', e.target.value)
                          }
