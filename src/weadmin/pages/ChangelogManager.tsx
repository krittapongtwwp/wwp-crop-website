...
export default function ChangelogManager() {
  ...
  const getTypeLabel = (type: string) => {
    switch (type) {
      case 'feature':
        return { en: 'New Feature', th: 'ฟีเจอร์ใหม่', color: 'bg-emerald-50 text-emerald-600 dark:bg-emerald-500/10' }
      case 'fix':
        return { en: 'Bug Fix', th: 'แก้ไขข้อผิดพลาด', color: 'bg-rose-50 text-rose-600 dark:bg-rose-500/10' }
      default:
        return { en: 'Improvement', th: 'การปรับปรุง', color: 'bg-blue-50 text-primary-blue dark:bg-primary-blue/10' }
    }
  }
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <h1 className="text-3xl font-bold text-text-main dark:text-white tracking-tight">
            ระบบบันทึกการปรับปรุง / Changelog System
          </h1>
          <p className="text-text-secondary dark:text-gray-400 mt-1">จัดการข้อมูลการอัปเดตและปรับปรุงระบบ</p>
        </div>
        <button onClick={() => handleEdit()} className="wwp-button-primary shadow-lg shadow-primary-blue/20">
          ...
          <form onSubmit={handleSave} className="space-y-8">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div>
                ...
                <input
                  type="date"
                  required
                  value={currentLog.published_at ? new Date(currentLog.published_at).toISOString().split('T')[0] : ''}
              ...
              <div className="flex items-center space-x-3 pt-8">
                ...
                <label
                  ...
                  className="text-sm font-bold text-text-main dark:text-white cursor-pointer">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="space-y-6">
                <h3 className="text-sm font-bold text-primary-blue uppercase tracking-widest border-b border-blue-100 dark:border-blue-900/20 pb-2">
                  English Content
                </h3>
                <div>
            ...
            <div className="flex justify-end space-x-4 pt-6 border-t border-border-subtle dark:border-white/5">
              <button type="button" onClick={() => setIsEditing(false)} className="wwp-button-secondary">
                ยกเลิก / Cancel
              </button>
              <button type="submit" disabled={saving} className="wwp-button-primary px-8">
            ...
            <div className="grid grid-cols-1 gap-6">
                        ...
                        <div className="flex-1">
                          <div className="flex items-center gap-3 mb-4 flex-wrap">
                            <div className="flex items-center gap-1 group/copy">
                              <span className="text-2xl font-black text-primary-blue tracking-tighter">
                                {log.version}
                              </span>
                              <button
                            ...
                            <span
                              className={`px-3 py-1 rounded-lg text-[10px] font-bold uppercase tracking-widest ${typeInfo.color}`}>
                            ...
                            <span className="text-xs font-bold text-text-muted bg-gray-100 dark:bg-white/5 px-3 py-1 rounded-lg">
                              {new Date(log.published_at).toLocaleDateString('th-TH', {
                                day: 'numeric',
                                month: 'long',
                                year: 'numeric'
                              })}
              ...
              {visibleCount < filteredChangelogs.length && (
                <div className="flex justify-center pt-4">
                  <button onClick={() => setVisibleCount((prev) => prev + 10)} className="wwp-button-secondary px-12">
