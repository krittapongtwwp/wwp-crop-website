          ...
          <div className="h-20 flex items-center px-8 border-b border-border-subtle dark:border-white/5">
            <Link to="/weadmin" className="flex items-center space-x-3 group">
              ...
              <div className="flex flex-col">
                <span className="text-lg font-bold tracking-tight text-primary-deep dark:text-white leading-none">
                  WeAdmin
                </span>
                <span className="text-[10px] font-semibold uppercase tracking-widest text-primary-blue mt-1 opacity-80">
                  Enterprise
                </span>
              </div>
            </Link>
            ...
            {navigation.map((item) => {
              ...
              return (
                <Link
                  ...
                  <item.icon
                    className={`w-5 h-5 mr-3.5 flex-shrink-0 transition-colors ${
                      isActive
                  ...
                  {isActive && (
                    <div className="w-1.5 h-1.5 rounded-full bg-primary-blue shadow-[0_0_8px_rgba(43,113,237,0.6)]" />
                  )}
                </Link>
              )
            })}
