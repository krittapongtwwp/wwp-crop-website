  ...
  const handleSend = async (text: string) => {
    ...
    try {
      ...
      const aiResponse: Message = {
        ...
        type: 'ai',
        text: response || t("I'm sorry, I couldn't process that request.", 'ขออภัย ฉันไม่สามารถประมวลผลคำขอนั้นได้')
      }
      ...
      const errorResponse: Message = {
        ...
        text: t(
          ...
          'ขณะนี้ฉันกำลังประสบปัญหาทางเทคนิค โปรดลองอีกครั้งในภายหลัง'
        )
      }
